...
//        val description: String = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam euismod malesuada felis, at condimentum orci egestas nec. Aenean pulvinar mauris turpis, sit amet dictum libero."
        ...
        val boarderHeight: Int = lastDescriptionY + 43
        // Define height
        val height: Int = boarderHeight + 10

        // (NOTE: generated by https://github.com/github/personal-website and http://www.hiqpdf.com/demo/ConvertHtmlToSvg.aspx)
        val svg =
         // <?xml version="1.0" encoding="UTF-8"?>
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="450" height={s"${height}"} version="1.2" baseProfile="tiny">
            <defs />
            <g fill="none" stroke="black" stroke-width="1" fill-rule="evenodd" stroke-linecap="square" stroke-linejoin="bevel">
              <g fill="#ffffff" fill-opacity="1" stroke="none" transform="matrix(1,0,0,1,0,0)">
                <rect x="0" y="0" width="450" height={s"${height}"} />
              </g>
              <!-- Boarder -->
              <rect x="0" y="0" width="440" height={s"${boarderHeight}"} stroke="#eaecef" stroke-width="3" />
