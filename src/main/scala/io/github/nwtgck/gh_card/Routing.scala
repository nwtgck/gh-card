...
//        val description: String = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam euismod malesuada felis."
        ...
        println(descriptionLines.length)
        println(descriptionLines)
        println(s"descriptionY: ${lastDescriptionY}")
          ...
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="450" height="160" version="1.2" baseProfile="tiny">
            ...
            <g fill="none" stroke="black" stroke-width="1" fill-rule="evenodd" stroke-linecap="square" stroke-linejoin="bevel">
              ...
              <g fill="#586069" fill-opacity="1" stroke="#586069" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="bevel" transform="matrix(1,0,0,1,0,0)">
                <!-- The number of stars -->
                <text fill="#586069" fill-opacity="1" stroke="none" xml:space="preserve" x="126" y={s"${lastDescriptionY + 26}"} font-family="sans-serif" font-size="12" font-weight="400" font-style="normal">306</text>
              </g>
              <!-- Fork icon -->
              ...
              <g fill="#586069" fill-opacity="1" stroke="#586069" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="bevel" transform="matrix(1,0,0,1,0,0)">
                <!-- The number of forks -->
                <text fill="" fill-opacity="1" stroke="none" xml:space="preserve" x="185" y={s"${lastDescriptionY + 26}"} font-family="sans-serif" font-size="12" font-weight="400" font-style="normal">6</text>
              </g>
              <!-- Language color -->
